...
import type { Route, RouterOptions } from 'next/dist/server/router';
...
import BaseServer, { Options, FindComponentsResult, MiddlewareRoutingItem, RequestContext } from 'next/dist/server/base-server';
...
declare type RenderWorker = Worker & {
    initialize: typeof import('next/dist/server/lib/render-server').initialize;
    deleteCache: typeof import('next/dist/server/lib/render-server').deleteCache;
    deleteAppClientCache: typeof import('next/dist/server/lib/render-server').deleteAppClientCache;
    clearModuleContext: typeof import('next/dist/server/lib/render-server').clearModuleContext;
};
export default class NextNodeServer extends BaseServer {
    ...
    protected renderWorkerOpts?: Parameters<typeof import('next/dist/server/lib/render-server').initialize>[0];
