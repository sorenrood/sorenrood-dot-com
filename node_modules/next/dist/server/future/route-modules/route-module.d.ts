...
export declare abstract class RouteModule<D extends RouteDefinition = RouteDefinition, U = unknown> {
     ...
     */
    readonly requestAsyncStorage: import("next/dist/client/components/request-async-storage").RequestAsyncStorage;
    /**
     * A reference to the static generation async storage.
     */
    readonly staticGenerationAsyncStorage: import("next/dist/client/components/static-generation-async-storage").StaticGenerationAsyncStorage;
    /**
     * An interface to call server hooks which interact with the underlying
     * storage.
     */
    readonly serverHooks: typeof import("next/dist/client/components/hooks-server-context");
    /**
     * An interface to call header hooks which interact with the underlying
     * request storage.
     */
    readonly headerHooks: typeof import("next/dist/client/components/headers");
    /**
     * An interface to call static generation bailout hooks which interact with
     * the underlying static generation storage.
     */
    readonly staticGenerationBailout: import("next/dist/client/components/static-generation-bailout").StaticGenerationBailout;
    /**
