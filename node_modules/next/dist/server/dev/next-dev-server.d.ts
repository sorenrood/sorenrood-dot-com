...
import { DevRouteMatcherManager } from 'next/dist/server/future/route-matcher-managers/dev-route-matcher-manager';
...
export default class DevServer extends Server {
    ...
    protected getRoutes(): {
        ...
        handlers: import("next/dist/server/future/route-handler-managers/route-handler-manager").RouteHandlerManager;
    };
    ...
    generateRoutes(dev?: boolean): {
        headers: readonly import("next/dist/server/router").Route[];
        rewrites: {
            beforeFiles: readonly import("next/dist/server/router").Route[];
            afterFiles: readonly import("next/dist/server/router").Route[];
            fallback: readonly import("next/dist/server/router").Route[];
        };
        redirects: readonly import("next/dist/server/router").Route[];
        catchAllRoute: import("next/dist/server/router").Route;
        catchAllMiddleware: readonly import("next/dist/server/router").Route[];
        matchers: import("next/dist/server/future/route-matcher-managers/route-matcher-manager").RouteMatcherManager;
        useFileSystemPublicRoutes: boolean;
        nextConfig: import("next/dist/server/config-shared").NextConfig;
        i18nProvider?: import("next/dist/server/future/helpers/i18n-provider").I18NProvider | undefined;
