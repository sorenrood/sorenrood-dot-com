...
import { L as LoaderOptions } from './types-c6bbc84b.js';
...
declare const buildDynamicMDX: (content: string, { remarkLinkRewriteOptions, ...loaderOptions }?: Pick<LoaderOptions, "defaultShowCopyCode" | "flexsearch" | "staticImage" | "readingTime" | "latex" | "codeHighlight"> & {
    mdxOptions?: (Pick<_mdx_js_mdx_lib_core.ProcessorOptions, "rehypePlugins" | "remarkPlugins"> & {
        format?: "md" | "mdx" | "detect" | undefined;
