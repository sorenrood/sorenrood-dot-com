...
export type CompileData = import('mdast-util-from-markdown').CompileData
...
export type CompileContext = {
   ...
   */
  getData: <Key extends keyof import('mdast-util-from-markdown').CompileData>(
    key: Key
  ) => import('mdast-util-from-markdown').CompileData[Key]
  /**
   *   Set data into the key/value store.
   */
  setData: <Key_1 extends keyof import('mdast-util-from-markdown').CompileData>(
    key: Key_1,
    value?: import('mdast-util-from-markdown').CompileData[Key_1] | undefined
  ) => void
  /**
