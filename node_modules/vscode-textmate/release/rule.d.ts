import { OrMask } from 'vscode-textmate/release/utils';
import { IOnigLib, IOnigCaptureIndex, FindOption, OnigString } from 'vscode-textmate/release/onigLib';
import { ILocation, IRawGrammar, IRawRepository, IRawRule } from 'vscode-textmate/release/rawGrammar';
