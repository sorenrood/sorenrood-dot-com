...
export type PluginOptions = import('@mdx-js/mdx/lib/core.js').PluginOptions;
export type BaseProcessorOptions = import('@mdx-js/mdx/lib/core.js').BaseProcessorOptions;
/**
 * Core configuration.
 */
